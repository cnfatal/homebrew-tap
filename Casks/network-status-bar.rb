cask "network-status-bar" do
  ...
  url "https://github.com/cnfatal/NetworkStatusBar/releases/latest/download/NetworkStatusBar.tar.gz"
  ...
  zap trash: "~/Library/Preferences/com.cnfatal.NetworkStatusBar.plist"
end
